...
class Palettes:
	...
	def get_palette(self):
		...
		# rainbow palette
		Painter_goblin_palette(unicode("#🌈", "utf-8"), [(0x03, 0x03, 0xc1),
			(0x00, 0xFF, 0x00), (0xFF, 0xFF, 0x00), (0xFF, 0x7F, 0x00),
			(0xFF, 0x00, 0x00)]),
		...
		# France
		Painter_goblin_palette(unicode("#LeTriTricolore 🇫🇷",'utf-8'),
		...
		Painter_goblin_palette("#VelvetUnderground", [(0xec, 0xef, 0xeb),
			(0xec, 0xef, 0xeb), (0xec, 0xef, 0xeb), (0xf5, 0xd3, 0x17),
			(0x00, 0x00, 0x00)]),
		...
		# Jack Kirby, https://twitter.com/70sscifiart/status/902283302727385088
		Painter_goblin_palette("#KirbyArgo #One", [(0x1a,0x1d,0x11),
			(0x4a,0x31,0xc8), (0xfc,0x09,0x56), (0x00,0xc1,0xee),
			(0xff,0xf6,0x00)]),

		# Jack Kirby, https://twitter.com/70sscifiart/status/902283302727385088
		Painter_goblin_palette("#KirbyArgo #Two", [(0x00,0x00,0x00),
			(0x2d,0x1d,0xff), (0xe8,0x00,0x57), (0x00,0xac,0xf4),
			(0xfb,0xfe,0x00)]),

		# Yves Klein
		Painter_goblin_palette(unicode("#YvesKlein #Anthropométrie", 'utf-8'),
			[(0x11,0x12,0x89),
			(0x06,0x10,0xc5), (0x27,0x25,0x5d), (0x98,0x9d,0xe1),
			(0xfd,0xfe,0xf8)]),

		# Parking Garage
		Painter_goblin_palette("#Unknown #ParkingGarage", [(0x83,0x00,0x00),
		    (0x00,0x00,0x00), (0x00,0x53,0x2e), (0xff,0x1a,0x27),
		    (0x00,0xf4,0xc8)]),

		# Neukölln / Reuterstrasse
		Painter_goblin_palette(unicode("#Neukölln", 'utf-8'),
			[(0x33,0x35,0x34), (0xed,0x34,0x3c), (0x94,0x8d,0x7e),
			 (0xde,0x81,0x2a), (0xff,0xff,0xff)]),

		# Crypt of Dracula
		Painter_goblin_palette("#CryptOfDracula",
			[(0x12,0x14,0x37), (0xae,0x00,0x3d), (0x3c,0x4b,0x7e),
			 (0x73,0x8c,0xc7), (0xb3,0xf7,0xff)]),

		# Berlin Bahnhof
		Painter_goblin_palette("#Bahnhof",
			[(0x1d,0x09,0x00), (0x3e,0x31,0x37), (0x9e,0x27,0x00),
			 (0xff,0x6d,0x07), (0xc6,0xbf,0xb8)]),

		# Berlin Ballet Grafiti
		Painter_goblin_palette("#Ballet",
			[(0x1a,0x10,0x0e), (0x61,0x4d,0x4a), (0xaf,0xb7,0x27),
			 (0x8a,0xbf,0xa6), (0xcb,0xad,0xa4)]),

		# Manabe's Psychadelic Cities
		Painter_goblin_palette("#Manabe",
			[(0xd5,0x2c,0x7f), (0x5b,0x8a,0xd2), (0xf5,0xe2,0x83),
			 (0xd0,0xb0,0xc5), (0xc0,0x58,0x97)]),

		# Wall at the American Museum of Visionary Art featuring the artist
		# Greg Mort's work.
		Painter_goblin_palette("#AmericanVisionary", [(0x80,0x00,0x00),
			(0xba,0x00,0x00), (0xe5,0x00,0x00), (0xff,0x00,0x00),
			(0xff,0x41,0x00)])
		]
